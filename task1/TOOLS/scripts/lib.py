...
def load_task2_runtime_config() -> dict[str, Any]:
    ...
    defaults = {
        ...
        "baseline_max_src_ips_per_user": 200 if large_mode else 5000,
        "baseline_max_src_subnets_per_user": 500 if large_mode else 2000,
        "baseline_max_session_ids_per_user": 500 if large_mode else 10000,
        "baseline_max_session_sequences_per_user": 500 if large_mode else 5000,
        "baseline_max_actions_per_session": 16 if large_mode else 16,
        ...
        "sequence_max_actions_per_session": 16 if large_mode else 200,
