...
run_step "reattribute_session_users" python3 "${PROJECT_ROOT}/scripts/task2/reattribute_session_users.py" --run-dir "${RUN_DIR}"
run_step "stage1_build_baseline" python3 "${PROJECT_ROOT}/scripts/task2/stage1_build_baseline.py" --run-dir "${RUN_DIR}"
run_step "stage1_detect_candidates" python3 "${PROJECT_ROOT}/scripts/task2/stage1_detect_candidates.py" --run-dir "${RUN_DIR}" --input-dir "${INPUT_DIR}"
run_step "extract_stage2_scope" python3 "${PROJECT_ROOT}/scripts/task2/extract_stage2_scope.py" --run-dir "${RUN_DIR}"
